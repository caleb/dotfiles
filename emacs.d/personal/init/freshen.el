(defun personal/delete-out-of-date-bytecode (directory)
  ...
  (dolist (path-and-attributes (directory-files-and-attributes directory t))
    (let ((path       (car path-and-attributes))
      ...
      (cond ((string-prefix-p "." (file-name-nondirectory path))
            ...
            ((eq (car attributes) t) ; explicity test for directory
             (personal/delete-out-of-date-bytecode path))
...
(personal/delete-out-of-date-bytecode
