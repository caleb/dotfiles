...
(make-face 'mode-line-god-mode-off)
(make-face 'mode-line-god-mode-on)

(defun personal/reset-mode-line ()
  "Reset my mode line to how I like it"
  (interactive)
  (setq-default mode-line-format '(; Place the God mode indicator
...
;; Helper function
(defun personal/shorten-directory (dir max-length)
