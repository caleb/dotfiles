# Generated by Powerlevel10k configuration wizard on 2019-12-28 at 22:15 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%240F\uE0B1'
  # The left end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%240F\uE0B3'
  ...
  typeset -g POWERLEVEL9K_DIR_BOLD=false
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%14F'    # yellow foreground
